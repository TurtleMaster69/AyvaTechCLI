...
export default function Content2({ component,imgUrl }: BlogComponent) {
  return (
    <Box sx={{ width: '100%', height: '100%', my: 18, display: 'flex', justifyContent: 'space-evenly' }}>
      ...
      <Box sx={{ width: '50%', pl: 10, pr: 0, display: 'flex', alignItems: 'start', justifyContent: 'center', flexDirection: 'column' }}>
